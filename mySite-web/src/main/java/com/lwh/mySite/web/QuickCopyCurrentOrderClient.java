...
public class QuickCopyCurrentOrderClient {
    ...
    private static double fixed_risk_rate = 0.01;//资金风险率。最大0.1
    ...
    public static void main( String[] args ) {
        ...
        RiskStrategyModel strategyModel = FixedRiskStrategyImpl.getStrategyModel(fixed_min_unit, fixed_risk_rate, initAmount, sscInfo.getCurrentOrder().getOrderCount());
